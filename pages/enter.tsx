      ...
      <div className="mt-16">
          ...
          <div className="mt-1">
            {method === "email" ? (
              <input
                id="input"
                type="email"
                className="w-full appearance-none rounded-md border border-gray-300 px-3 py-2 placeholder-gray-400 shadow-sm focus:border-orange-500 focus:ring-orange-500"
                required
              />
            ) : null}
            {method === "phone" ? (
        ...
        <div className="mt-8">
          ...
          <div className="mt-6 grid grid-cols-2 gap-3">
            <button className="items-center- boder-gray-300 flex justify-center rounded-md border bg-white py-2 px-4 text-sm font-medium text-gray-500 shadow-sm hover:bg-gray-50">
              <svg
                className="h-5 w-5"
                aria-hidden="true"
                fill="currentColor"

export default function chatDetail() {
  return (
    <div className="space-y-4 px-4 py-10">
      ...
      <div className="fixed inset-x-0 bottom-2 mx-auto w-full max-w-md px-4">
        <div className="flex items-center">
          <input
            type="text"
            className="relative w-full rounded-full border-gray-300 shadow-sm focus:border-orange-500 focus:outline-none focus:ring-orange-500"
          />
